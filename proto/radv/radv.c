...
static struct ea_def ea_radv_preference, ea_radv_lifetime;
...
static struct ea_def ea_radv_preference = {
  .name = "radv_preference",
  .type = EAF_TYPE_INT,
  .f_type = T_ENUM_RA_PREFERENCE,
  .format = radv_preference_format,
};

static struct ea_def ea_radv_lifetime = {
  .name = "radv_lifetime",
  .type = EAF_TYPE_INT,
  .f_type = T_INT,
};
